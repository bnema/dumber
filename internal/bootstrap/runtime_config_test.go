...
func runtimeConfigWithNestedMutableFields() *config.Config {
	...
	cfg.Workspace.VimMode.Actions = map[string]entity.ActionBinding{
		"vim-scroll-down": {Keys: []string{"j"}, Desc: "Scroll down"},
	}
...
func mutateNestedRuntimeConfigSnapshot(snapshot entity.RuntimeConfigSnapshot) {
	...
	mutateActionBinding(snapshot.UI.Workspace.VimMode.Actions, "vim-scroll-down", "mutated-page")
	snapshot.UI.Workspace.VimMode.Actions["added-page"] = entity.ActionBinding{Keys: []string{"added"}}
...
func assertNestedRuntimeConfigSnapshotUnchanged(t *testing.T, snapshot entity.RuntimeConfigSnapshot) {
	...
	assertActionBinding(t, snapshot.UI.Workspace.VimMode.Actions, "vim-scroll-down", "j")
	assertMapEntryAbsent(t, snapshot.UI.Workspace.VimMode.Actions, "added-page")
...
func assertNestedSourceConfigUnchanged(t *testing.T, cfg *config.Config) {
	...
	assertActionBinding(t, cfg.Workspace.VimMode.Actions, "vim-scroll-down", "j")
	assertMapEntryAbsent(t, cfg.Workspace.VimMode.Actions, "added-page")
