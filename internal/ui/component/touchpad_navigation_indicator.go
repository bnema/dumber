...
func (i *TouchpadNavigationIndicator) ShowGesture(gesture entity.TouchpadNavigationGesture) {
	...
	if gesture.Action == entity.TouchpadNavigationForward {
...
func touchpadNavigationIndicatorIcon(gesture entity.TouchpadNavigationGesture) string {
	if gesture.Action == entity.TouchpadNavigationForward {
		return "→"
	}
	return "←"
...
func touchpadNavigationIndicatorLabel(gesture entity.TouchpadNavigationGesture) string {
	suffix := "Back"
	if gesture.Action == entity.TouchpadNavigationForward {
		suffix = "Forward"
	}
