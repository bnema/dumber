	...
	return &Config{
		...
		Workspace: WorkspaceConfig{
			...
			Shortcuts: GlobalShortcutsConfig{
				...
				ConsumeOrExpelLeft:  "ctrl+bracketleft",
				ConsumeOrExpelRight: "ctrl+bracketright",
				ConsumeOrExpelUp:    "ctrl+shift+bracketleft",
				ConsumeOrExpelDown:  "ctrl+shift+bracketright",
			},
