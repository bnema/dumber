		...
		Workspace: WorkspaceConfig{
			...
			Shortcuts: GlobalShortcutsConfig{
				Actions: map[string]ActionBinding{
					...
					"toggle_history_systemview":   {Keys: []string{"ctrl+h"}, Desc: "Toggle History in right split"},
					"toggle_favorites_systemview": {Keys: []string{}, Desc: "Toggle Favorites in right split"},
					"toggle_config_systemview":    {Keys: []string{}, Desc: "Toggle Config in right split"},
