		...
		Workspace: WorkspaceConfig{
			...
			VimMode: VimModeConfig{
				...
				Actions: map[string]ActionBinding{
					...
					"yank-paragraph":       {Keys: []string{"yap"}, Desc: "Yank first visible paragraph"},
					"yank-code":            {Keys: []string{"yac"}, Desc: "Yank first visible code block"},
					"yank-table":           {Keys: []string{"yat"}, Desc: "Yank first visible table"},
					"yank-list":            {Keys: []string{"yal"}, Desc: "Yank first visible list"},
					"hint-follow":          {Keys: []string{"f"}, Desc: "Show hints and follow a link or control"},
					"hint-follow-new":      {Keys: []string{"F"}, Desc: "Show hints and open a link in a new pane"},
					"hint-yank-url":        {Keys: []string{"yf"}, Desc: "Show hints and yank a link URL"},
					"visual":               {Keys: []string{"v"}, Desc: "Start visual selection (motions extend, y yanks)"},
