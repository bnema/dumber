...
type CEFInputConfig struct {
	...
	ScrollTouchpadInertia              bool    `mapstructure:"scroll_touchpad_inertia" toml:"scroll_touchpad_inertia" yaml:"scroll_touchpad_inertia"`                                           //nolint:lll // struct tags exceed lll limit
	ScrollWheelSmoothing               bool    `mapstructure:"scroll_wheel_smoothing" toml:"scroll_wheel_smoothing" yaml:"scroll_wheel_smoothing"`                                             //nolint:lll // struct tags exceed lll limit
