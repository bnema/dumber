...
func (*SchemaProvider) getPerformanceKeys(defaults *Config) []entity.ConfigKeyInfo {
	return []entity.ConfigKeyInfo{
		...
		},
		{
			...
			Description: "Enable two-finger touchpad swipe back/forward navigation for CEF views",
			Section:     SectionPerformance,
		},
		{
			...
			Description: "Minimum accumulated horizontal touchpad swipe delta required for CEF back/forward navigation",
			Range:       ">0",
			Section:     SectionPerformance,
		},
		{
