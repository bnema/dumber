...
func (*SchemaProvider) getWorkspaceKeys(defaults *Config) []entity.ConfigKeyInfo {
	return []entity.ConfigKeyInfo{
		...
		// Global shortcuts
		{
			Key:         "workspace.shortcuts.close_pane",
			Type:        "string",
			Default:     defaults.Workspace.Shortcuts.ClosePane,
			Description: "Global shortcut to close current pane",
			Section:     SectionWorkspace,
		},
		{
			Key:         "workspace.shortcuts.next_tab",
			Type:        "string",
			Default:     defaults.Workspace.Shortcuts.NextTab,
			Description: "Global shortcut to switch to next tab",
			Section:     SectionWorkspace,
		},
		{
			Key:         "workspace.shortcuts.previous_tab",
			Type:        "string",
			Default:     defaults.Workspace.Shortcuts.PreviousTab,
