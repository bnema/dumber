...
func (m *Manager) setWorkspaceDefaults(defaults *Config) {
	...
	m.viper.SetDefault("workspace.styling.vim_mode_color", defaults.Workspace.Styling.VimModeColor)
	m.viper.SetDefault("workspace.styling.mode_legend_linger", defaults.Workspace.Styling.ModeLegendLinger)
