...
func (m *Manager) setWorkspaceDefaults(defaults *Config) {
	...
	m.viper.SetDefault("workspace.page_mode.activation_shortcut", defaults.Workspace.PageMode.ActivationShortcut)
	m.viper.SetDefault("workspace.page_mode.timeout_ms", defaults.Workspace.PageMode.TimeoutMilliseconds)
	m.viper.SetDefault("workspace.page_mode.actions", defaults.Workspace.PageMode.Actions)
