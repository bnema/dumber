...
//
//	mockgen -source=internal/db/interfaces.go -destination=internal/db/mocks/mock_db.go
//
...
// MockExtensionsQuerier is a mock of ExtensionsQuerier interface.
type MockExtensionsQuerier struct {
	ctrl     *gomock.Controller
	recorder *MockExtensionsQuerierMockRecorder
	isgomock struct{}
}

// MockExtensionsQuerierMockRecorder is the mock recorder for MockExtensionsQuerier.
type MockExtensionsQuerierMockRecorder struct {
	mock *MockExtensionsQuerier
}

// NewMockExtensionsQuerier creates a new mock instance.
func NewMockExtensionsQuerier(ctrl *gomock.Controller) *MockExtensionsQuerier {
	mock := &MockExtensionsQuerier{ctrl: ctrl}
	mock.recorder = &MockExtensionsQuerierMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockExtensionsQuerier) EXPECT() *MockExtensionsQuerierMockRecorder {
	return m.recorder
}

// CheckExtensionNeedsUpdate mocks base method.
func (m *MockExtensionsQuerier) CheckExtensionNeedsUpdate(ctx context.Context, days float64, extensionID string) (db.CheckExtensionNeedsUpdateRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckExtensionNeedsUpdate", ctx, days, extensionID)
	ret0, _ := ret[0].(db.CheckExtensionNeedsUpdateRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CheckExtensionNeedsUpdate indicates an expected call of CheckExtensionNeedsUpdate.
func (mr *MockExtensionsQuerierMockRecorder) CheckExtensionNeedsUpdate(ctx, days, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckExtensionNeedsUpdate", reflect.TypeOf((*MockExtensionsQuerier)(nil).CheckExtensionNeedsUpdate), ctx, days, extensionID)
}

// CleanupOldDeletedExtensions mocks base method.
func (m *MockExtensionsQuerier) CleanupOldDeletedExtensions(ctx context.Context, days float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanupOldDeletedExtensions", ctx, days)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanupOldDeletedExtensions indicates an expected call of CleanupOldDeletedExtensions.
func (mr *MockExtensionsQuerierMockRecorder) CleanupOldDeletedExtensions(ctx, days any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanupOldDeletedExtensions", reflect.TypeOf((*MockExtensionsQuerier)(nil).CleanupOldDeletedExtensions), ctx, days)
}

// GetInstalledExtension mocks base method.
func (m *MockExtensionsQuerier) GetInstalledExtension(ctx context.Context, extensionID string) (db.GetInstalledExtensionRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetInstalledExtension", ctx, extensionID)
	ret0, _ := ret[0].(db.GetInstalledExtensionRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetInstalledExtension indicates an expected call of GetInstalledExtension.
func (mr *MockExtensionsQuerierMockRecorder) GetInstalledExtension(ctx, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInstalledExtension", reflect.TypeOf((*MockExtensionsQuerier)(nil).GetInstalledExtension), ctx, extensionID)
}

// ListInstalledExtensions mocks base method.
func (m *MockExtensionsQuerier) ListInstalledExtensions(ctx context.Context) ([]db.ListInstalledExtensionsRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListInstalledExtensions", ctx)
	ret0, _ := ret[0].([]db.ListInstalledExtensionsRow)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListInstalledExtensions indicates an expected call of ListInstalledExtensions.
func (mr *MockExtensionsQuerierMockRecorder) ListInstalledExtensions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListInstalledExtensions", reflect.TypeOf((*MockExtensionsQuerier)(nil).ListInstalledExtensions), ctx)
}

// MarkExtensionDeleted mocks base method.
func (m *MockExtensionsQuerier) MarkExtensionDeleted(ctx context.Context, extensionID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkExtensionDeleted", ctx, extensionID)
	ret0, _ := ret[0].(error)
	return ret0
}

// MarkExtensionDeleted indicates an expected call of MarkExtensionDeleted.
func (mr *MockExtensionsQuerierMockRecorder) MarkExtensionDeleted(ctx, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkExtensionDeleted", reflect.TypeOf((*MockExtensionsQuerier)(nil).MarkExtensionDeleted), ctx, extensionID)
}

// SetExtensionEnabled mocks base method.
func (m *MockExtensionsQuerier) SetExtensionEnabled(ctx context.Context, enabled bool, extensionID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetExtensionEnabled", ctx, enabled, extensionID)
	ret0, _ := ret[0].(error)
	return ret0
}

// SetExtensionEnabled indicates an expected call of SetExtensionEnabled.
func (mr *MockExtensionsQuerierMockRecorder) SetExtensionEnabled(ctx, enabled, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetExtensionEnabled", reflect.TypeOf((*MockExtensionsQuerier)(nil).SetExtensionEnabled), ctx, enabled, extensionID)
}

// UpsertInstalledExtension mocks base method.
func (m *MockExtensionsQuerier) UpsertInstalledExtension(ctx context.Context, arg db.UpsertInstalledExtensionParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertInstalledExtension", ctx, arg)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpsertInstalledExtension indicates an expected call of UpsertInstalledExtension.
func (mr *MockExtensionsQuerierMockRecorder) UpsertInstalledExtension(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertInstalledExtension", reflect.TypeOf((*MockExtensionsQuerier)(nil).UpsertInstalledExtension), ctx, arg)
}
...
// CheckExtensionNeedsUpdate mocks base method.
func (m *MockDatabaseQuerier) CheckExtensionNeedsUpdate(ctx context.Context, days float64, extensionID string) (db.CheckExtensionNeedsUpdateRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CheckExtensionNeedsUpdate", ctx, days, extensionID)
	ret0, _ := ret[0].(db.CheckExtensionNeedsUpdateRow)
	ret1, _ := ret[1].(error)
...
// CheckExtensionNeedsUpdate indicates an expected call of CheckExtensionNeedsUpdate.
func (mr *MockDatabaseQuerierMockRecorder) CheckExtensionNeedsUpdate(ctx, days, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CheckExtensionNeedsUpdate", reflect.TypeOf((*MockDatabaseQuerier)(nil).CheckExtensionNeedsUpdate), ctx, days, extensionID)
}

// CleanupOldDeletedExtensions mocks base method.
func (m *MockDatabaseQuerier) CleanupOldDeletedExtensions(ctx context.Context, days float64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanupOldDeletedExtensions", ctx, days)
	ret0, _ := ret[0].(error)
	return ret0
...
// CleanupOldDeletedExtensions indicates an expected call of CleanupOldDeletedExtensions.
func (mr *MockDatabaseQuerierMockRecorder) CleanupOldDeletedExtensions(ctx, days any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanupOldDeletedExtensions", reflect.TypeOf((*MockDatabaseQuerier)(nil).CleanupOldDeletedExtensions), ctx, days)
}
...
// GetInstalledExtension mocks base method.
func (m *MockDatabaseQuerier) GetInstalledExtension(ctx context.Context, extensionID string) (db.GetInstalledExtensionRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetInstalledExtension", ctx, extensionID)
	ret0, _ := ret[0].(db.GetInstalledExtensionRow)
	ret1, _ := ret[1].(error)
...
// GetInstalledExtension indicates an expected call of GetInstalledExtension.
func (mr *MockDatabaseQuerierMockRecorder) GetInstalledExtension(ctx, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetInstalledExtension", reflect.TypeOf((*MockDatabaseQuerier)(nil).GetInstalledExtension), ctx, extensionID)
}
...
// ListInstalledExtensions mocks base method.
func (m *MockDatabaseQuerier) ListInstalledExtensions(ctx context.Context) ([]db.ListInstalledExtensionsRow, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListInstalledExtensions", ctx)
	ret0, _ := ret[0].([]db.ListInstalledExtensionsRow)
	ret1, _ := ret[1].(error)
...
// ListInstalledExtensions indicates an expected call of ListInstalledExtensions.
func (mr *MockDatabaseQuerierMockRecorder) ListInstalledExtensions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListInstalledExtensions", reflect.TypeOf((*MockDatabaseQuerier)(nil).ListInstalledExtensions), ctx)
}
...
// MarkExtensionDeleted mocks base method.
func (m *MockDatabaseQuerier) MarkExtensionDeleted(ctx context.Context, extensionID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MarkExtensionDeleted", ctx, extensionID)
	ret0, _ := ret[0].(error)
	return ret0
...
// MarkExtensionDeleted indicates an expected call of MarkExtensionDeleted.
func (mr *MockDatabaseQuerierMockRecorder) MarkExtensionDeleted(ctx, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MarkExtensionDeleted", reflect.TypeOf((*MockDatabaseQuerier)(nil).MarkExtensionDeleted), ctx, extensionID)
}
...
// SetExtensionEnabled mocks base method.
func (m *MockDatabaseQuerier) SetExtensionEnabled(ctx context.Context, enabled bool, extensionID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetExtensionEnabled", ctx, enabled, extensionID)
	ret0, _ := ret[0].(error)
	return ret0
...
// SetExtensionEnabled indicates an expected call of SetExtensionEnabled.
func (mr *MockDatabaseQuerierMockRecorder) SetExtensionEnabled(ctx, enabled, extensionID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetExtensionEnabled", reflect.TypeOf((*MockDatabaseQuerier)(nil).SetExtensionEnabled), ctx, enabled, extensionID)
}
...
// UpsertInstalledExtension mocks base method.
func (m *MockDatabaseQuerier) UpsertInstalledExtension(ctx context.Context, arg db.UpsertInstalledExtensionParams) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpsertInstalledExtension", ctx, arg)
	ret0, _ := ret[0].(error)
	return ret0
...
// UpsertInstalledExtension indicates an expected call of UpsertInstalledExtension.
func (mr *MockDatabaseQuerierMockRecorder) UpsertInstalledExtension(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpsertInstalledExtension", reflect.TypeOf((*MockDatabaseQuerier)(nil).UpsertInstalledExtension), ctx, arg)
}
