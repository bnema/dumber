...
clean: ## Clean build artifacts
	...
	rm -f assets/gui/gui.min.js assets/gui/homepage.min.js assets/gui/homepage.css assets/gui/main-world.min.js assets/gui/color-scheme.js assets/gui/gui.min.css
